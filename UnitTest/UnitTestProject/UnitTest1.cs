    ...
    public class UnitTest1
    {
        ...
        public void LoadFile()
        {
            ...
            using (var reader = StreamFactory.CreateReader(writer.BaseStream))
            {
                ...
                writer.Flush();
                stream.Position = 0;
                var loadedApp = AppDataSerializeService.LoadFromStream(reader.ReadToEnd(), false);
        ...
        private static AppData BuildDummyData()
        {
            ...
            orgApp.MileStones.Add(new MileStone("all star", new Project("Pro1"), new CallenderDay(2018, 6, 3), Color.AliceBlue, new MileStoneFilter("testMileStoneFilter"), TaskState.Active));
            return orgApp;
        }

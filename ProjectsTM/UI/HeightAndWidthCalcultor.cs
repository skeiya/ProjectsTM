...
namespace ProjectsTM.UI
{
    internal class HeightAndWidthCalcultor
    {
        ...
        private readonly List<WorkItem> _listItems;
        ...
        public HeightAndWidthCalcultor(Font font, Graphics g, List<WorkItem> listItems, Func<WorkItem, ColIndex, string> getText, int colCount)
        {
            this._font = font;
            this._graphics = g;
